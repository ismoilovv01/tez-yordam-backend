...
function App() {
  ...
  const [dispatcherToken, setDispatcherToken] = useState(localStorage.getItem('policeDispatcherToken'));
  ...
  const handleLogin = async (phone, code) => {
    ...
    try {
      ...
      localStorage.setItem('policeDispatcherToken', token);
  ...
  const handleLogout = () => {
    localStorage.removeItem('policeDispatcherToken');
