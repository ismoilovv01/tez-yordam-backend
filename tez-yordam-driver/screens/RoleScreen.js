    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.topBar}>
        <TouchableOpacity style={s.topBtn} onPress={() => setDarkMode(!darkMode)}>
          <Text style={s.topBtnIcon}>{darkMode ? '☀️' : '🌙'}</Text>
        </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  langDropdown: {
    ...
    minWidth: 180, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 16, elevation: 8,
  },
  ...
  heroIcon: { fontSize: 72, zIndex: 1, marginBottom: 16 },
